...
$query_user_acc_charges = "SELECT * FROM accounts";
$user_acc_charges = mysql_query($query_user_acc_charges, $u_charges) or die(mysql_error());
$row_user_acc_charges = mysql_fetch_assoc($user_acc_charges);
$totalRows_user_acc_charges = mysql_num_rows($user_acc_charges);
	$acc = array();
	$acc = $row_user_acc_charges;
	echo implode(" ",$acc);
?>
...
<?php
mysql_free_result($user_acc_charges);
?>
